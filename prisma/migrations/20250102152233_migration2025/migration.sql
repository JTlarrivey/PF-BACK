...
-- CreateTable
CREATE TABLE "_FriendsAsFollowers" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_FriendsAsFollowers_AB_unique" ON "_FriendsAsFollowers"("A", "B");

-- CreateIndex
CREATE INDEX "_FriendsAsFollowers_B_index" ON "_FriendsAsFollowers"("B");
...
-- AddForeignKey
ALTER TABLE "_FriendsAsFollowers" ADD CONSTRAINT "_FriendsAsFollowers_A_fkey" FOREIGN KEY ("A") REFERENCES "User"("user_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_FriendsAsFollowers" ADD CONSTRAINT "_FriendsAsFollowers_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("user_id") ON DELETE CASCADE ON UPDATE CASCADE;
